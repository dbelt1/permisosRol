                ...
                <div class="card-body">
                    ...
                    <form action="{{route('role.update',$role->id)}}"  method="POST">
                        ...
                        <div class="container">
                            ...
                            <div class="form-group">
                                <label>Slug</label>
                                <input type="text" class="form-control" name="slug" placeholder="slug" value="{{ old('slug',$role->slug)}}">
                            </div>

                            <div class="form-group">
                                <label>Description</label>
                        
                                <textarea cols="30" rows="10" class="form-control" id="description" name="description" >{{ old('description',$role->description)}} </textarea>
                            </div>
